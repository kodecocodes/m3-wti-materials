...
This repo contains all the downloadable materials and projects associated with the **Writing Tools** module in:
...
| --------------------------------------------------------------------------------------- |:-------:|:------------:|
| [versions/1.0](https://github.com/kodecocodes/m3-wti-materials/tree/versions/1.0) | 1.0     | YYYY-MM-DD   |
